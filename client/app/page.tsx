...
const TRANSLATIONS: any = {
  en: {
    ...
    auth_2fa: "Enter code from Authenticator",
    auth_verify: "Verify 2FA",
    auth_remember: "Remember me",
    dock_dm: "Direct Messages",
    side_req: "Requests",
    ...
    steam_join: "🚀 Join Lobby",
    steam_launch: "▶ Launch Game",
    chat_placeholder: "Message... @mention",
    chat_select: "Select a Channel",
    call_return: "🔊 Call in Progress — Click to Return",
    btn_accept: "Accept",
    btn_decline: "Decline",
    btn_cancel: "Cancel",
    btn_save: "Save",
    ...
    set_setup_2fa: "Setup 2FA",
    set_verify: "Verify & Enable",
    set_scan: "Scan with Google Authenticator",
    set_ringtone: "Incoming Call Ringtone",
    set_pass_change: "Change Password",
    set_new_pass: "New Password",
    set_confirm: "Confirm & Logout",
    set_upload: "Upload Photo",
    set_gif: "Choose GIF",
    set_steam: "Link Steam",
    set_steam_linked: "Steam Linked",
    set_logout: "Log Out",
    set_lang: "Language",
    ctx_copy: "Copy Text",
    ...
    ctx_call: "Start Call",
    ctx_id: "Copy ID",
    ctx_remove: "Remove Friend",
    ctx_add: "Add Friend",
    ctx_edit: "Edit Message",
    ctx_reply: "Reply",
    chat_editing: "Editing...",
    chat_replying: "Replying to",
    call_incoming: "Incoming Call...",
    call_ended: "End Call",
    call_duration: "Duration",
    room_idle: "DJ Idle",
    room_playing: "Now Playing",
    room_search: "Search YouTube..."
  },
  ro: {
    auth_user: "Nume utilizator",
    auth_pass: "Parolă",
    auth_login: "Autentificare",
    auth_register: "Creează Cont",
    auth_back: "Înapoi la Login",
    auth_2fa: "Introdu codul din Authenticator",
    auth_verify: "Verifică 2FA",
    auth_remember: "Ține-mă minte",
    dock_dm: "Mesaje Directe",
    side_req: "Cereri",
    side_friends: "Prieteni",
    side_channels: "Canale",
    status_on: "Conectat",
    status_off: "Deconectat",
    status_playing: "Se joacă",
    steam_join: "🚀 Intră în Lobby",
    steam_launch: "▶ Pornește Jocul",
    chat_placeholder: "Scrie un mesaj... @mențiune",
    chat_select: "Selectează un Canal",
    call_return: "🔊 Apel în Desfășurare — Apasă pentru a reveni",
    btn_accept: "Acceptă",
    btn_decline: "Refuză",
    btn_cancel: "Anulează",
    btn_save: "Salvează",
    ...
    btn_stop: "Oprește",
    set_header: "Setări",
    set_2fa: "Autentificare în 2 Pași",
    set_setup_2fa: "Activează 2FA",
    set_verify: "Verifică & Activează",
    set_scan: "Scanează cu Google Authenticator",
    set_ringtone: "Ton de Apel",
    set_pass_change: "Schimbă Parola",
    set_new_pass: "Parolă Nouă",
    set_confirm: "Confirmă & Delogare",
    set_upload: "Încarcă Foto",
    set_gif: "Alege GIF",
    set_steam: "Leagă Steam",
    set_steam_linked: "Steam Legat",
    set_logout: "Delogare",
    set_lang: "Limbă",
    ctx_copy: "Copiază Text",
    ctx_delete: "Șterge Mesaj",
    ctx_profile: "Profil",
    ctx_call: "Începe Apel",
    ctx_id: "Copiază ID",
    ctx_remove: "Șterge Prieten",
    ctx_add: "Adaugă Prieten",
    ctx_edit: "Editează",
    ctx_reply: "Răspunde",
    chat_editing: "Editare...",
    chat_replying: "Răspuns către",
    call_incoming: "Apel de intrare...",
    call_ended: "Încheie Apel",
    call_duration: "Durată",
    room_idle: "DJ Inactiv",
    room_playing: "Acum Redă",
    room_search: "Caută pe YouTube..."
  }
};
...
const TAGLINES = [
  "Tel Aviv group trip 2026 ?", "Debis", "Endorsed by the Netanyahu cousins", 
  "Also try DABROWSER", "Noua aplicatie suvenirista", "No Basinosu allowed", 
  "Nu stati singuri cu bibi pe VC", "E buna Purcela", "I AM OBEZ DELUXE 2026 ?", 
  "500 pe seara", "Sure buddy", "Mor vecinii", "Aplicatie de jocuri dusmanoasa", 
  "Aplicatie de jocuri patriotica", "Aplicatie de jocuri prietenoasa", 
  "Sanatate curata ma", "Garju 8-bit", "Five Nights at Valeriu (rip)", 
  "Micu Vesel group trip 20(si ceva) ?"
];
    ...
    <GlassPanel className={className || "absolute bottom-24 left-4 w-[90%] max-w-90 h-120 rounded-4xl flex flex-col z-50 overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-300 shadow-2xl ring-1 ring-white/10"}>
      ...
      <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
        <div className="columns-2 gap-3 space-y-3">
          {gifs.map((g) => (
            <div key={g.id} className="relative group overflow-hidden rounded-2xl cursor-pointer transition-all hover:scale-[1.02] hover:ring-2 ring-blue-500/50" onClick={() => onSelect(g?.media_formats?.gif?.url)}>
...
const DaChatLogo = ({ className = "w-12 h-12" }: { className?: string }) => (
  <img src="/logo.png" alt="DaChat Logo" className={`${className} object-contain rounded-xl transition-transform hover:scale-110 duration-300`} />
);
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center justify-between bg-black/40 p-3 rounded-lg border border-white/10">
                          ...
                          <button
                            ...
                            className={`w-8 h-8 flex items-center justify-center rounded-full transition-all duration-200 ${isPreviewing
